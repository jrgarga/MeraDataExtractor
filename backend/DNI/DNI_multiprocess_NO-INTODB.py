...
#    name = OUT+"_"+y+"_"+m+"_GribIndexPoints_SWIMFULL.csv";
...
#    Process(target = example,args=('/var/www/html/mera/map/backup/thread/Press/MERA_PRODYEAR_'+year+'_'+smonth+'_1_103_0_0_FC3hr','Pressure','true',smonth,year,yar)).start()
    Process(target = example,args=('/var/www/html/mera/map/backup/thread/DNI/MERA_PRODYEAR_'+year+'_'+smonth+'_140_105_0_4_FC3hr','DNI','true',smonth,year,yar)).start()
