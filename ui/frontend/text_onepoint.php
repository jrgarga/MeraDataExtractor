...
//                        document.getElementById('ReloadThisAsWell').innerHTML = $http.responseText;
                ...
                $http.open('GET', './frontend_helpers/loadtext_onepoint.php' + '?' + new Date().getTime(), true);
                $http.send(null);
            }
...
<font size=3>
<center><a href="#bottom">Go Bottom</a>&nbsp &nbsp &nbsp &nbsp<a href="graph_multipoint_2020.php" target=_blank>Go to Graph View</a>&nbsp &nbsp &nbsp &nbsp
...
-->
 ...
 <a href="./frontend_helpers/output_onepoint.txt" download><button  type="button">Direct Download</br> (Current Version in TXT format)</button></a>
