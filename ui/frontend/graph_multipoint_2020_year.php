...
$file = file("./frontend/output_onepoint.txt");
...
<b>
<font size=3>
<center><a href="text_onepoint_year.php" target=_blank>Go to Tabular View</a>&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp<a href="../" target=_blank>Return to Main Page</a></br>

</br>

 <a id="indir" name="indir" href="./frontend_helpers/output_onepoint.txt" download><button  type="button">Direct Download</br> (Current Version in TXT format)</button></a>&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp
...
function myStopFunction() {
  clearTimeout(myVar);
  document.getElementById('countdown').innerHTML = "Auto-refresh stopped.";
}
...
else if (players[i].index==uniques[9])
{
zdata10.push(players[i].value);
}
else if (players[i].index==uniques[10])
{
zdata11.push(players[i].value);
}
else if (players[i].index==uniques[11])
{
zdata12.push(players[i].value);
}
else if (players[i].index==uniques[12])
{
zdata13.push(players[i].value);
}
else if (players[i].index==uniques[13])
{
zdata14.push(players[i].value);
}
else if (players[i].index==uniques[14])
{
zdata15.push(players[i].value);
}
else if (players[i].index==uniques[15])
{
zdata16.push(players[i].value);
}
...
//   borderDash: [5, 5],
   ...
   pointBorderColor: "#55bae7",
   pointHoverBackgroundColor: "fuchsia",
   pointHoverBorderColor: "#55bae7",
   pointRadius: 5,
   pointHoverRadius: 25,
   data: zdata14,
}/*,{
   label: uniques[14]+' '+nedir[0],
//   label: 'Temperature9',
   fill: false,
   borderColor: "brown",
//   borderDash: [5, 5],
...
//              boxWidth:45
    ...
    title: {
            display: true,
	    fontSize: 22,
            text: "Showing *"+nedir[0]+"* for Grib Index Points "+uniques.slice(0, 16)
        }
    },
    data: {
labels:datezozaman,
...
//   borderDash: [5, 5],
   ...
   pointBorderColor: "#55bae7",
   pointHoverBackgroundColor: "khaki",
   pointHoverBorderColor: "#55bae7",
   pointRadius: 5,
   pointHoverRadius: 25,
   data: zdata15,
...
//   borderDash: [5, 5],
   ...
   pointBorderColor: "#55bae7",
   pointHoverBackgroundColor: "lavender",
   pointHoverBorderColor: "#55bae7",
   pointRadius: 5,
   pointHoverRadius: 25,
   data: zdata16,
...
XHR.open("GET", "/mera/map/which.txt", true);
XHR.send();
XHR.onload = function (){
    console.log( "len-"+XHR.responseText.slice(0, XHR.responseText.indexOf("\n")) );
};
...
console.log(lineOne);
//return lineOne;
//    console.log( 'bu hala burda; '+XHR.responseText.slice(0, XHR.responseText.indexOf("\n")) );
};
...
/*
if (parseInt(data)>=100)
{        $('#test').html('<font size=10 color=green>Extraction process: 100% [finished]</font></br></br><a href=\"https://aqua.ucd.ie/mera/map\" target=_blank><button  type=\"button\">Check Exported CSVs</br></button></a></br>');
}
else if (parseInt(data)==0)
{        $('#test').html('<font size=10 color=red>Extraction process: 0% starting...</font>');
}
else
{       $('#test').html('<font size=10 color=blue>Extraction process: '+parseInt(data)+'%</font>');
}
        $('#file').val(data);
*/
naber = data;
...
//return interesting;
//}
document.getElementById('indir').href="./frontend_helpers/output_onepoint"+naber+".txt";
// Request data using D3
d3
//  .csv("https://s3-us-west-2.amazonaws.com/s.cdpn.io/2814973/atp_wta.csv")
  .csv("./frontend_helpers/output_onepoint"+naber+".txt")
  .then(makeChart);
...
//console.log('taaalasdas'+interesting);
//console.log('taaalasdas'+dahadainteresting);
//console.log('taaalasdas'+selectedVar);
//myStopFunction();
...
document.getElementById('indir').href="./frontend_helpers/output_onepoint"+selectedVar+".txt";
// Request data using D3
//var newfile= "
d3
//  .csv("https://s3-us-west-2.amazonaws.com/s.cdpn.io/2814973/atp_wta.csv")
